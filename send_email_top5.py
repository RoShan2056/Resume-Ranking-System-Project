...
def send_email_top5(to_list, job_title, job_company):
    #TODO: mail pathau da  dynamic job title huna paro
    port = 587  # For starttls
    smtp_server = "smtp.gmail.com"
    sender_email = "umeshmgr16@gmail.com"
    password = "qjcwfewmwterubea"
    ...
    with smtplib.SMTP(smtp_server, port) as server:
        ...
        for to in to_list:
            ...
            message["Subject"] = f"Congratulations! You are a top-ranked candidate for {job_title} position"
...
We are pleased to inform you that your application for the {job_title} position has been ranked as one of the top resumes from our list of applicants. Your experience and skills match our requirements exceptionally well, and we would like to thank you for your interest in the position.
